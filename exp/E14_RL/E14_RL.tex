...
\huge  E14 Reinforcement Learning (C++/Python)\\ % The assignment title
...
\begin{enumerate}
	...
	\end{figure}
	\item Please submit a file named \texttt{E14\_YourNumber.pdf} and send it to \texttt{ai\_2018@foxmail.com}
\end{enumerate}
