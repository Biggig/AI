...
\begin{figure}[htbp]
\centering
\includegraphics[width=14cm]{classified_result.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=14cm]{Mu.png}
\caption{$\mu$}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=12cm]{cov_matrix_1.png}
\caption{$\Sigma$ for class0}
\end{figure}
 \
\begin{figure}[h]
\centering
\includegraphics[width=12cm]{cov_matrix_2.png}
\caption{$\Sigma$ for class1}
\end{figure}
 \
\begin{figure}[h]
\centering
\includegraphics[width=12cm]{cov_matrix_3.png}
...
\centering
\includegraphics[width=6cm]{Gamma_1.png}
\caption{$\gamma$}
\end{minipage}
\begin{minipage}[t]{0.48\textwidth}
\centering
\includegraphics[width=6cm]{Gamma_2.png}
\caption{$\gamma$}
\end{minipage}
\begin{minipage}[t]{0.48\textwidth}
\centering
\includegraphics[width=6cm]{Gamma_3.png}
\caption{$\gamma$}
\end{minipage}
\end{figure}
