...
StrokeType = ConditionalProbabilityTable(
    [['Ischemic Stroke', 'Ischemic Stroke', 'Ischemic Stroke', 0.8],
     ...
     'Hemmorraghic Stroke', 0],
     ['Ischemic Stroke', 'Hemmorraghic Stroke', \
     'Hemmorraghic Stroke', 0.4],
     ['Hemmorraghic Stroke', 'Ischemic Stroke', \
     'Hemmorraghic Stroke', 0.4],
     ['Hemmorraghic Stroke', 'Hemmorraghic Stroke', \
     'Hemmorraghic Stroke', 0.9],
...
p1 = model.predict_proba(
    {'PatientAge': '31-65'})[5].parameters[0]
print('p1 = ')
print(p1)
print()
...
p2 = model.predict_proba(
    {'PatientAge': '65+',  \
    'MRIScanResult': 'Hemmorraghic Stroke'})[6].parameters[0]
print('p2 = ')
print(p2)
print()

p3 = model.predict_proba(
    {'PatientAge': '65+', 'MRIScanResult': 'Ischemic Stroke', 'CTScanResult': 'Hemmorraghic Stroke'})[3].parameters[0]
print('p3 = ')
print(p3)
print()

p4 = model.predict_proba(
    {'PatientAge': '31-65'})[4].parameters[0]['Used']
print('p4 = ')
print(p4)
print()

p5 = model.predict_proba(
    {'Disability': 'Negligible'})[4].parameters[0]
print('p5 = ')
print(p5)
print()
